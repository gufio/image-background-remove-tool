...
from bgremover.libs import strings
...
class U2NET:
    ...
    def __init__(self, name="u2net"):
        ...
        from bgremover.libs.u2net import U2NET as U2NET_DEEP
        from bgremover.libs.u2net import U2NETP as U2NETP_DEEP
...
class BasNet:
    ...
    def __init__(self, name="basnet"):
        import torch
        from torch.autograd import Variable
        from bgremover.libs.basnet import BASNet as BASNet_DEEP
